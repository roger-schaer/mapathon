      ...
      <div className="help-div">
        ...
        <div className="help-question">
          <table>
            <tr>
              <th>
                <h2>What is mapathon used for? </h2>
              </th>
            </tr>
            <tr>
              <td><p className="help-text">Mapathon is a tool that allows you to save your points of interest and display them on the map.
                ...
                which you will have entered in advance.</p>
                <p className="help-text">Each POI can be edited or deleted, except for the pre-recorded ones.</p>
              </td>
              <td><img className="help-img-right" src="https://www.ccfmarrakech.com/wp-content/uploads/2018/10/GATE_Mock-Test.jpg"/>
              </td>
            </tr>
          </table>
        </div>
        ...
        <div className="help-question">
          <table>
            ...
            <tr>
              ...
              <td>
                <p className="help-text">Using Mapathon is simple. Once connected, you can access the list of POIs by clicking on Get POIs.
                  The list of saved POIs will be displayed, both on the right and on the map.
                </p>
              </td>
            </tr>
            <tr>
              <td><p className="help-text">The markers on the map will display a popup with basic information about the point of interest in question.
                The list on the right provides access to the selected POI website.</p>
                <p className="help-text">Each POI can be edited or deleted, except for the pre-recorded ones.</p>
              </td>
              <td><img className="help-img-right" src="https://www.ccfmarrakech.com/wp-content/uploads/2018/10/GATE_Mock-Test.jpg"/>
              </td>
        ...
        <div className="help-question">
          <table>
            ...
            <tr>
              ...
              <td>
                <p className="help-text">In the toolbar, at the top right, is written "login". By clicking on it, you will be able
        ...
        <div className="help-question">
          <table>
            <tr>
              <th>
                <h2>How can I add a new point of interest? </h2>
              </th>
            </tr>
        ...
        <div className="help-question">
          <table>
            <tr>
              <th>
                <h2>How can I edit one of my POIs?</h2>
              </th>
            </tr>
            <tr>
              <td>
                <p className="help-text" >When you have selected a POI on the MAP, a popup will open with the main information about it. By clicking on "more info",
                  the following page will open, offering the possibility to edit the different data of the chosen POI.</p>
              </td>
              <td>
                <img className="help-img-right" src="https://www.ccfmarrakech.com/wp-content/uploads/2018/10/GATE_Mock-Test.jpg"/>
              </td>
        ...
        <div className="help-question">
          <table>
            <tr>
              <th>
                <h2>How can I delete one of my POIs?</h2>
              </th>
            </tr>
            <tr>
              <td>
                <p className="help-text">The process is the same as for editing. Once the POI has been selected and the detailed information page opened, the Delete button is available.
                  Clicking on it will delete the POI and return you to the map page.</p>
              </td>
              <td>
                <img className="help-img-right" src="https://www.ccfmarrakech.com/wp-content/uploads/2018/10/GATE_Mock-Test.jpg"/>
              </td>
